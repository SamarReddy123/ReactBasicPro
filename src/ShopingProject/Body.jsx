...
const Body = (props) => {
  const { title, image1, image2, image3, image4, image5, image6, image7, price1, price2, price3, price4, price5, price6, price7 } = props.mens;
  return (
    <div>
      <div>
        <img src="https://d16pnh712pyiwa.cloudfront.net/wp-content/uploads/2020/11/Landing-page-banner-scaled.jpg" alt="" className="banner" />
      </div>
      <div>
